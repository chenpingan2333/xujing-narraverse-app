...
export default function ProfilePage() {
  ...
  return (
    <>
      <Content style={{ maxWidth: 600, margin: "0 auto", padding: "20px 16px", minHeight: "100vh", paddingBottom: 100 }} className="page-scroll">
        <div style={{ display: "flex", alignItems: "center", marginBottom: 20 }}>
          <BackButton />
          <Title level={4} style={{ margin: 0, color: "#5C4033", fontWeight: 400,
        ...
        {/* VIP Status */}
        <div onClick={() => router.push("/membership")} style={{
