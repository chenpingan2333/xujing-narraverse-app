...
import { PlusOutlined, ArrowLeftOutlined, SettingOutlined, DownOutlined, UpOutlined } from "@ant-design/icons";
          ...
          {showAdvanced && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14, marginTop: 12, padding: 16, background: "#fdf8f0", borderRadius: 12, border: "1px solid #ead9c0" }}>
              <div>
                ...
                <Input placeholder="比如：喜欢用'呢'、'嘛'结尾，说话带点撒娇……" value={newChar.speechStyle}
              ...
              <div>
                ...
                <TextArea placeholder="她/他有过怎样的经历？为什么成为现在这样？" rows={3}
              ...
              <div>
                ...
                <TextArea placeholder="第一次见面时她/他会说什么？" rows={2}
